...
{
    public class when_creating_a_charge_with_a_source
    {
        ...
        Establish context = () =>
        {
            ...
            StripeChargeCreateOptions = test_data.stripe_charge_create_options.ValidSource(_stripeCustomer.Id, _stripeCustomer.StripeDefaultCardId);
        };
        ...
        It should_have_the_source = () =>
            StripeCharge.Source.ShouldNotBeNull();
